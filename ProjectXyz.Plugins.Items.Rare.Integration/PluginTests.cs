...
namespace ProjectXyz.Plugins.Items.Rare.Tests.Integration
{
    [Items]
    [ApplicationLayer]
    public class PluginTests : DatabaseTest
    {
        ...
        public void GenerateItemCallbackInvoke_SimpleDefinition_MatchesDefinition()
        {
            ...
            dataManager.Items.ItemTypeGeneratorPlugins.Add(
                ...
                typeof(RareItemGenerator).FullName);
            ...
            var itemTypeGrouping = dataManager.Items.ItemTypeGroupings.Add(
                Guid.NewGuid(),
                Guid.NewGuid(),
                addResult.ItemDefinition.ItemTypeId);

            var prefixNameStringResource = StringResourceRepositoryHelper.AddStringResource(
                dataManager,
                "Item Prefix");
            dataManager.Items.ItemNameAffixes.Add(
                Guid.NewGuid(),
                true,
                itemTypeGrouping.GroupingId,
                magicTypeGrouping.GroupingId,
                prefixNameStringResource.Id);

            var suffixNameStringResource = StringResourceRepositoryHelper.AddStringResource(
                dataManager,
                "Item Suffix");
            dataManager.Items.ItemNameAffixes.Add(
                Guid.NewGuid(),
            ...
            Assert.Equal(
                prefixNameStringResource.Id,
                result.ItemNameParts.First().NameStringResourceId);
            Assert.Equal(
                suffixNameStringResource.Id,
                result.ItemNameParts.Last().NameStringResourceId);
