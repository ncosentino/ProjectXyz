...
namespace ProjectXyz.Application.Tests.Items
{
    ...
    public class ItemAffixGeneratorTests
    {
        ...
        public void ItemAffixGenerator_GenerateRandomTwoAffixes_ReturnsTwoEnchantments()
        {
            ...
            itemAffixFactory
                .SetupSequence(x => x.CreateItemAffix(It.IsAny<IEnumerable<IEnchantment>>()))
            ...
            Assert.Equal(affix2.Object, result[1]);
            ...
            enchantmentGenerator.Verify(x => x.Generate(randomizer.Object, ENCHANTMENT_ID1), Times.Once);
            enchantmentGenerator.Verify(x => x.Generate(randomizer.Object, ENCHANTMENT_ID2), Times.Once);
