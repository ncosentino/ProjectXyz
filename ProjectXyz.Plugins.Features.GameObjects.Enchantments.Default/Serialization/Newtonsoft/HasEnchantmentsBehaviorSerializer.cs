...
namespace ProjectXyz.Plugins.Features.GameObjects.Enchantments.Default.Serialization.Newtonsoft
{
    public sealed class HasEnchantmentsBehaviorSerializer : IDiscoverableCustomSerializer
    {
            ...
            serializableId) =>
        {
            ...
            hasEnchantmentsBehavior.AddEnchantmentsAsync(enchantments);
