...
namespace ProjectXyz.Data.Sql.Tests.Unit.Items.MagicTypes
{
    [DataLayer]
    [Items]
    public class MagicTypeRepositoryTests
    {
        #region Methods
        [Fact]
        ...
        public void GetById_NotAvailable_Throws()
        {
            ...
            // Assert
            Assert.Equal("No magic type with Id '" + id + "' was found.", exception.Message);
        ...
        public void RemoveById_IdExists_Success()
        {
            ...
            var factory = new Mock<IMagicTypeFactory>();
        ...
        public void Add_ValidObject_Success()
        {
            ...
            var createdObject = new Mock<IMagicType>(MockBehavior.Strict);
