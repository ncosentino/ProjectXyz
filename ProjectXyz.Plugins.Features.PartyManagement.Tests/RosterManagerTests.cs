...
namespace ProjectXyz.Plugins.Features.PartyManagement.Tests
{
    public sealed class RosterManagerTests
    {
        ...
        {
            var actor1 = new GameObject(new[]
            {
                new RosterBehavior(),
            });
            var actor2 = new GameObject(new[]
            {
                new RosterBehavior(),
            });
        ...
        [Fact]
        private void RemoveFromRoster_MultiplePartyWasLeader_NewLeaderSingleActiveParty()
        {
            var actor1 = new GameObject(new[]
            {
                new RosterBehavior(),
        ...
        [Fact]
        private void SetIsPartyLeader_MultipleRosterNoActiveParty_NewLeaderSingleActiveParty()
        {
            var actor1 = new GameObject(new[]
            {
                new RosterBehavior(),
