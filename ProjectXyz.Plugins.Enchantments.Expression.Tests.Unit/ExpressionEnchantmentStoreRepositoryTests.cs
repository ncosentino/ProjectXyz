...
namespace ProjectXyz.Plugins.Enchantments.Expression.Tests.Unit
{
    [DataLayer]
    [Enchantments]
    public class ExpressionEnchantmentStoreRepositoryTests
    {
        #region Constants
        ...
        public void GetById_IdExists_ExpectedValues()
        {
            ...
            var enchantmentStore = new Mock<IExpressionEnchantmentStore>();
        ...
        public void RemoveById_IdExists_Success()
        {
            ...
            var factory = new Mock<IExpressionEnchantmentStoreFactory>();
