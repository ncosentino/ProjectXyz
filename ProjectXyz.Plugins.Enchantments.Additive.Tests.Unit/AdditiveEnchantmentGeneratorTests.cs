...
namespace ProjectXyz.Plugins.Enchantments.Additive.Tests.Unit
{
    ...
    public class AditiveEnchantmentGeneratorTests
    {
        ...
        public void Generate_ValidArguments_Success()
        {
            ...
            var enchantment = new Mock<IAdditiveEnchantment>();

            var enchantmentDefinition = new Mock<IAdditiveEnchantmentDefinition>();
            ...
            var additiveEnchantmentFactory = new Mock<IAdditiveEnchantmentFactory>();
            ...
            var enchantmentGenerator = AdditiveEnchantmentGenerator.Create(additiveEnchantmentFactory.Object);
