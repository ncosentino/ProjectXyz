...
{
    public sealed class NegateEnchantmentTypeCalculator : IEnchantmentTypeCalculator
    {
        #region Fields
        ...
        #region Constructors
        private NegateEnchantmentTypeCalculator(
        ...
        {
            return new NegateEnchantmentTypeCalculator(statusNegationRepository);
        }
